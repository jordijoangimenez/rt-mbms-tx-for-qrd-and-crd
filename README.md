...
[Configuration Templates](https://github.com/5G-MAG/rt-mbms-tx-for-qrd-and-crd/tree/main/Config-Template) can be downloaded and placed in ``/root/.config/srsran/`` for execution after installation.
